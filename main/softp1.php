	...
	<div class="panel panel-widget forms-panel">
						...
						<div class="forms">
								...
								<div class="form-three widget-shadow">
									<form class="form-horizontal" action="softp.php" enctype="multipart/form-data" method="post">
...
<option value="New Software">New Software</option>
...
<option value="Ecommerce">Ecommerce</option>
										...
										<div class="col-sm-8">
										<input type="file" id="uploaded_file" name="uploaded_file[]" multiple="multiple" required="">
										</div>
										</div> 
