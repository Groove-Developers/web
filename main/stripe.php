...
if(!empty($_POST['stripeToken'])){
    ...
    //set api key
    $stripe = array(
      "secret_key"      => "sk_test_svjzIrhGdwv1m52Tz4jKtdfL",
      "publishable_key" => "pk_test_SbIckkRLpmnZN5RzlGs0DV8W"
    );
    ...
    if($chargeJson['amount_refunded'] == 0 && empty($chargeJson['failure_code']) && $chargeJson['paid'] == 1 && $chargeJson['captured'] == 1){
        ...
        include_once 'includes/storedb.php';
        ...
        if($last_insert_id && $status == 'succeeded'){
            ...
            header("Location: paypal_cancel.php");
        }
    }else{
