...
if(isset($_POST["submit"])){
 ...
 $sql = 'INSERT INTO users_project (username, project_type, status, project_name, project_file, project_cat, project_desc, minimum_pay, maximum_pay, start_date, due_date) VALUES ("'.$username.'","existing","pending","'.$project_name.'","'.$project_file.'","'.$project_cat.'","'.$project_desc.'","'.$minimum_pay.'","'.$maximum_pay.'","'.$start_date.'","'.$due_date.'") ';
	...
	<div class="panel panel-widget forms-panel">
						...
						<div class="forms">
								...
								<div class="form-three widget-shadow">
									<form class="form-horizontal" action="ep.php" enctype="multipart/form-data" method="post">
