...
if(isset($_POST["submit"])){
 ...
 $sql = 'INSERT INTO template (username, template_url, status, template_file, template_tagline, template_desc, minimum_pay, maximum_pay, reg_date) VALUES ("'.$username.'", "'.$template_url.'","pending","'.$template_file.'","'.$template_tagline.'","'.$template_desc.'","'.$minimum_pay.'","'.$maximum_pay.'", "'.$reg_date.'") ';
